...
nmap \te :Pytest error
nmap \tp :Pytest previous
nmap \tn :Pytest next
nmap \tm :Pytest method
nmap \tc :Pytest class
nmap \tf :Pytest file
nmap \wh :VimwikiAll2HTML
snoremap ^ b<BS>^
snoremap ` b<BS>`
...
set helplang=en
set mouse=a
set runtimepath=~/.vim,~/.vim/bundle/ack,~/.vim/bundle/command-t,~/.vim/bundle/cvim,~/.vim/bundle/fugitive,~/.vim/bundle/git,~/.vim/bundle/gundo,~/.vim/bundle/makegreen,~/.vim/bundle/nerdtree,~/.vim/bundle/pep8,~/.vim/bundle/powerline,~/.vim/bundle/py.test,~/.vim/bundle/pydoc,~/.vim/bundle/ropevim,~/.vim/bundle/snipmate,~/.vim/bundle/supertab,~/.vim/bundle/surround,~/.vim/bundle/tasklist,~/.vim/bundle/vim-session,/opt/local/share/vim/vimfiles,/opt/local/share/vim/vim73,/opt/local/share/vim/vimfiles/after,~/.vim/bundle/snipmate/after,~/.vim/after
set shiftwidth=4
set smarttab
set softtabstop=4
set tabstop=4
